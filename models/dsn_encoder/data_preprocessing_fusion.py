...
df_drugs_smiles = pd.read_csv('dataset/drugbank/drug_smiles.csv')
...
df_all_pos_ddi = pd.read_csv('dataset/drugbank/ddis.csv')
...
class DrugDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        pos_tri = (pos_h_samples, pos_t_samples, pos_rels, pos_b_samples, pos_pair_ids)
        ...
        neg_tri = (neg_h_samples, neg_t_samples, neg_rels, neg_b_samples, neg_pair_ids)
